      ...
      <div className="footer">
        ...
        <Row style={{ marginLeft: "10%", marginRight: "10%", padding: "15px" }}>
            ...
            <div className="footer-col">
              <div className="footer-item">
                ...
                <div className="item-box">
                  <span className="vc-address">Monday — Friday</span>
                  <br />
                  <span className="vc-address">10:00 AM to 9:00 PM (ET)</span>
                </div>
                <div className="item-box">
                  <span className="vc-address">Saturday</span>
                  <br />
                  <span className="vc-address">10:00 AM to 3:00 PM (ET)</span>
                </div>
              </div>
            </div>
          </Col>
          ...
          <Col lg={10}>
            ...
            <br />
            <br />
            <span className="footer-terms-details">
