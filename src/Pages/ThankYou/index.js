      ...
      <div className="thankyouCard">
        ...
        <Row className="cardBody">
          <Col className="leftSide" lg={10}>
            <center>
              <p style={{ fontSize: "16px", color: "gray" }}>4-Day/3-Night</p>
            ...
            <div className="dataTable">
              ...
              <div style={{ backgroundColor: "#f9f9f9" }} className="dataRow">
                <p>
                  ...
                  <span style={{ marginLeft: "30px" }}>4-Day/3-Night</span>
                </p>
              </div>
              <div className="dataRow">
                <p>
              ...
              <div style={{ backgroundColor: "#f9f9f9" }} className="dataRow">
                <p>
                  ...
                  <span style={{ marginLeft: "40px" }}>$507 Per Family</span>
                </p>
              </div>
              <div className="dataRow">
                <p>
                  <strong>Orignal Price:</strong>{" "}
                  <span style={{ marginLeft: "40px" }}>
                    <strong>$159</strong> Per Family For All Three Nights
                  </span>
                </p>
              </div>
              <div style={{ backgroundColor: "#f9f9f9" }} className="dataRow">
                <p>
                  <strong>Bonus</strong>{" "}
                  <span className="last_row" style={{ marginLeft: "90px" }}>
                    <strong>$100 AMEX GIFT CARD or Attraction Tickets</strong>
                  </span>
                </p>
              </div>
            </div>
          ...
          <Col className="rightSide" lg={12}>
            ...
            <div className="bluePanel">
              <h2>Call Now & We'll Gift You A Cruise</h2>
            </div>
            <Row>
              ...
              <Col lg={14} className="details">
                ...
                <p>
                  Receive a complimentary 3-night, fun-filled Cruise for two.
                  All your faboulas meals and exciting ship-board entertainment
                  are included during your cruise{" "}
                </p>
